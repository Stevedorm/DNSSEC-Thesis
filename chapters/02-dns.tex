...
the child zone, .jmu. To be able to query the child, you need a domain name, followed by .jmu.lab.
...
attacker inserts their malicious address in place of a cached address. They pretend to be a DNS nameserver and forge a reply, and with UDP it makes it even easier for this attack to occur.\cite{cache-poisoning}
