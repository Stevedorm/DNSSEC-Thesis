...
like a tree. Below in \cref{fig:dns} is a diagram from Bind9 demonstrating this hierarchy.\cite{bind-9}
...
\subsection{The DNS Environment}
...
replace it with malicious content. This is where DNSSEC comes into play, helping to mitigate and prevent many attacks from occurring.
...
\subsubsection{DNS Hijacking}
  ...
  to directly communicate with the attacker. They could also give an IP that delivers a malicious payload. These are some of the most basic types of attacks when it comes the DNS hijacking.