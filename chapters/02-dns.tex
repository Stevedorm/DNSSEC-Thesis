...
child server have authority over their own domains, and you can also traverse the tree to query the parent for information on the child server.
...
\subsection{DNS Vulnerabilities}
  SHOULD THIS BE MOVED TO DNSSEC, I'M THINKING SO.
