...
for a domain with dnssec enabled, receiving this flag back instead of a SERVFAIL status means that the data was successfully authenticated. You will not see it in the 
...
and the \hyperref[subsec:ksk]{Key Signing Key}. The identifying type number that this RR is a DNSKEY is 48. 

The general format for these RRs is as fo\cite{rfc4034} \cref{fig:dnskey}
...
This key has a shorter Time To Live, or TTL, because it is sent out and used much more frequently than the KSK.
