...
Gone are the @ symbols preceding lines, and there is a new minimum time record. At the bottom of the figure, yuo can see a \hyperref[subsec:ds]{Delegation Signer} record,
...
I receive the RRSet that is signed, seen below in \cref{fig:dnskey_diagram}. These keys are signed together as a set by the Key Signing Key, which name is pretty explanatory for 
...
\begin{figure}[htbp]
  \centering
  \fbox{\includegraphics[width=0.8\textwidth]{figures/dnssec/DNSKEY_q_diagram.png}}
  \caption{This query shows a dig at the parent for the DNSKEYs}
  \label{fig:dnskey}
\end{figure}
