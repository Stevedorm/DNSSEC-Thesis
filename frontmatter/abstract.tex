...
This study investigates the Domain Name System and the vulnerabilities that come with plain DNS. 
These vulnerabilities, like DNS Spoofing and Hijacking, usher in questions about how they can 
be prevented and mitigated. These attacks are discussed and demonstrated in this paper in a testbed environment. This is 
...
bringing authentication knowing that only the DNS server could have signed the record with the private key. 
...
to make sure they were valid. I compiled all of the code into a tar archive, accompanied by a Makefile script 
for compilation and key management, as well as remove the executable and old key files. A target exists for 
each validated record type, including the Address, Name Server, DNSKEY, and Start of Authority records. 
The appendix contains a procedure manual for the early steps of setting up the environment.